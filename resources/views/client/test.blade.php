                                            ...
                                            <div class="card-body px-4 py-2 border-[1px] border-t-0 rounded-b border-slate-500">
                                                ...
                                                @foreach($question->questionOptions as $option)
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="questions[{{ $question->id }}]" id="option-{{ $option->id }}" value="{{ $option->id }}" required @if(old("questions.$question->id") == $option->id) checked @endif>
